...
```lua
    local Elements = {
        ...
        {label = '<span style="color:green;">HEY! IM GREEN!</span>', name = "green_element"}
      }

      ESX.UI.Menu.Open("default", GetCurrentResourceName(), "Example_Menu", {
        title = "Example Menu", -- The Name of Menu to show to users,
        align = "top-left", -- "top-left" | "top-right" | "bottom-left" | "bottom-right" | "center" | "left-center" | "right-center"
